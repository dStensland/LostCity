...
-- ==========================================================================
-- Feed Events Ready: pre-computed denormalized feed table
-- Migration: supabase/migrations/20260324900024_feed_events_ready.sql
--            database/migrations/597_feed_events_ready.sql
-- ==========================================================================
...
BEGIN
  ...
  ON CONFLICT (event_id, portal_id) DO UPDATE SET
    ...
    series_slug = EXCLUDED.series_slug, refreshed_at = EXCLUDED.refreshed_at;
