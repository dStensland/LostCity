-- ============================================
-- MIGRATION 416: Cobb Family Programs Source
-- ============================================
-- Hooky family-focused public-program view over Cobb County's official Rec1
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Cobb Family Programs source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'cobb-family-programs';
