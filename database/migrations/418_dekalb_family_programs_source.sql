-- ============================================
-- MIGRATION 418: DeKalb Family Programs Source
-- ============================================
-- Hooky family-focused public-program view over DeKalb County Recreation's
-- official ACTIVENet catalog.
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register DeKalb Family Programs source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'dekalb-family-programs';
