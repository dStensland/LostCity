-- ============================================
-- MIGRATION 369: Zoo Atlanta Summer Safari Camp Source
-- ============================================
-- Official Zoo Atlanta summer safari camp page.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Institution-led camp page with age-track registration links and weekly
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Zoo Atlanta Summer Safari Camp source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'zoo-atlanta-summer-safari-camp';
