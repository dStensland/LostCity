-- ============================================
-- MIGRATION 321: Atlanta Vibe Schedule Source
-- ============================================
-- Official Atlanta Vibe upcoming home matches at Gas South Arena.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping Atlanta Vibe source registration.';
    RETURN;
  END IF;
  ...
  VALUES (
    'atlanta-vibe',
    'Atlanta Vibe',
    'https://www.gassouthdistrict.com/teams/detail/atlanta-vibe',
    'organization',
    'weekly',
    true,
    atlanta_portal_id,
  ...
  VALUES (
    ...
    'Home venue for Atlanta Vibe in Duluth.',
    true
  )
  ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
