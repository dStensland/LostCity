-- =============================================================
-- MIGRATION 380: Piedmont Park EnviroVentures Camp Source
-- =============================================================
-- Official Piedmont Park Conservancy summer camp inventory.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Piedmont Park camp source.';
  END IF;
  ...
  VALUES (
    'piedmont-park-enviroventures-camp',
    'Piedmont Park EnviroVentures Camp',
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'piedmont-park-enviroventures-camp';
