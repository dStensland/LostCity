-- ============================================
-- MIGRATION 459: International Woodworking Fair Source Tuning
-- ============================================
-- Retunes the existing IWF annual source to the exact official schedule page
-- and refreshes the matching festival metadata for the 2026 cycle.
