-- ============================================
-- MIGRATION 313: HelpATL Official Boards and Commissions Opportunities
-- ============================================
-- Adds structured official civic participation opportunities for Atlanta
-- boards and commissions while the municipal clerk meeting pages remain
-- blocked to crawler runtime.
