-- ============================================
-- MIGRATION 363: Nellya Beginner Camps Source
-- ============================================
-- Official Nellya Fencers Club beginner camp schedule.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Arts/movement camp implementation using visible beginner-camp week rows with
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Nellya source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'nellya-beginner-camps';
  ...
  VALUES (
    ...
    'fitness_center',
    'fitness',
    'https://www.nellyafencers.com/',
    'Atlanta fencing club offering beginner youth fencing camps and competitive training programs.'
  )
  ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
