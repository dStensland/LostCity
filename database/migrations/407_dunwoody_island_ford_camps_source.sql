-- ==================================================
-- MIGRATION 407: Dunwoody Island Ford Camps Source
-- ==================================================
-- Official Dunwoody Nature Center Island Ford summer camp inventory.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Dunwoody Island Ford Camps source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'dunwoody-island-ford-camps';
