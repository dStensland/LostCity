-- ============================================
-- MIGRATION 376: Lovett Summer Programs Source
-- ============================================
-- Official Summer at Lovett public catalog board.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Finalsite summer-program board with public type/week/school-level taxonomy.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Lovett Summer Programs source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'lovett-summer-programs';
