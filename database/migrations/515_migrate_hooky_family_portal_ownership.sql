-- ============================================
-- MIGRATION 515: Move Family ownership from hooky to atlanta-families
-- ============================================
...
BEGIN
  ...
  -- Merge overlapping subscriptions first to avoid unique conflicts on
  -- (subscriber_portal_id, source_id) when the remaining rows move over.
