-- ==============================================
-- MIGRATION 371: DeKalb Line Dance 101 Source
-- ==============================================
-- Public Line Dance 101 classes from DeKalb County Recreation.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping DeKalb line dance source registration.';
    RETURN;
  END IF;
  ...
  VALUES (
    ...
    'community_center',
    'https://apm.activecommunities.com/dekalbcountyrecreation/Activity_Search',
    'DeKalb County community center hosting public line dance classes.'
  )
  ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
