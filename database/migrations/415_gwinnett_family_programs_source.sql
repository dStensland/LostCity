-- ============================================
-- MIGRATION 415: Gwinnett Family Programs Source
-- ============================================
-- Hooky family-focused public-program view over Gwinnett County's official Rec1
-- catalog, limited to youth/family-relevant civic inventory.
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Gwinnett Family Programs source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'gwinnett-family-programs';
