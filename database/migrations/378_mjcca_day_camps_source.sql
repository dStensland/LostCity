-- ============================================
-- MIGRATION 378: MJCCA Day Camps Source
-- ============================================
-- Official MJCCA Summer Day Camps session catalog.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Brand-owned local camp-search network with paginated public session cards.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register MJCCA Day Camps source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'mjcca-day-camps';
