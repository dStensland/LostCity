-- ===============================================
-- MIGRATION 382: Gwinnett Tap Classes Source
-- ===============================================
-- Public active-adult tap classes from Gwinnett County Parks & Recreation.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping Gwinnett tap source registration.';
    RETURN;
  END IF;
