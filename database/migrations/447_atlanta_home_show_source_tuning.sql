-- ============================================
-- MIGRATION 447: Atlanta Home Show Source Tuning
-- ============================================
-- Reactivates the existing Atlanta Home Show source on the official show-info
-- page so the dedicated organizer parser can replace the Cobb shell row.
