-- ============================================
-- MIGRATION 377: City of Milton Parks & Recreation Source
-- ============================================
-- Official City of Milton Rec1 program catalog.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Civic Rec1 catalog for family camps, youth programs, and outdoor recreation.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register City of Milton Parks & Recreation source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'milton-parks-rec';
