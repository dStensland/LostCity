-- ==================================================
-- MIGRATION 406: Dunwoody Summer Camp Source
-- ==================================================
-- Official Dunwoody Nature Center summer camp inventory at Dunwoody Park.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Dunwoody Summer Camp source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'dunwoody-summer-camp';
