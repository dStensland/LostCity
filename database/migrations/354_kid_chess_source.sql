-- ============================================
-- MIGRATION 354: Kid Chess Seasonal Camps Source
-- ============================================
-- Official Kid Chess seasonal camps page with public camp tables, venue rows,
-- grade bands, and a public registration landing page.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   First reusable public camp-table implementation for family programming.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Kid Chess source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'kid-chess';
