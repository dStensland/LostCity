-- ============================================
-- MIGRATION 381: Frazer Nature Camp Source
-- ============================================
-- Official Frazer Center summer nature camp inventory.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Frazer Nature Camp source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'frazer-nature-camp';
