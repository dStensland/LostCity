...
--    Both category_id (FK column) and legacy category (text column)
UPDATE events SET category_id = 'exercise' WHERE category_id = 'fitness';
UPDATE events SET category    = 'exercise' WHERE category    = 'fitness' AND category_id IS NULL;
...
UPDATE events SET category = 'recreation'
