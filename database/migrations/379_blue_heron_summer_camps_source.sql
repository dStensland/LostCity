-- ============================================
-- MIGRATION 379: Blue Heron Summer Camps Source
-- ============================================
-- Official Blue Heron Nature Preserve summer camp inventory.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Blue Heron source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'blue-heron-summer-camps';
