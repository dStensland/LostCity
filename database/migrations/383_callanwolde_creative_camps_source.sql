-- ==================================================
-- MIGRATION 383: Callanwolde Creative Camps Source
-- ==================================================
-- Official Callanwolde creative summer camp inventory.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Callanwolde Creative Camps source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'callanwolde-creative-camps';
