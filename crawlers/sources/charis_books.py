...
def crawl(source: dict) -> tuple[int, int, int]:
    ...
    try:
            ...
            for block in blocks:
                try:
                    ...
                    for i, line in enumerate(lines):
                        ...
                        if re.match(r'^(In-Store|Online|Book Club|Fiction|Non-Fiction|Poetry|Trans|Workshop|Off-Site)', line, re.I):
                            continue
                        # Skip navigation/metadata
                        if any(skip in line for skip in ['DATE:', 'TIME:', 'PLACE:', 'VIEW EVENT', 'ABOUT', 'RSVP']):
                            break
                        # Skip address lines
                    ...
                    elif 'poetry' in title_lower or 'poet' in title_lower or 'open mic' in title_lower:
        ...
        logger.info(f"Charis Books crawl complete: {events_found} found, {events_new} new")
