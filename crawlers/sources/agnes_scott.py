"""
Crawler for Agnes Scott College Events (agnesscott.edu).
Arts, lectures, athletics, and campus events at the women's liberal arts college in Decatur.
"""
...
BASE_URL = "https://www.agnesscott.edu"
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Crawl Agnes Scott College events."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    try:
        ...
        for event_data in json_events:
            ...
            if any(w in title_lower for w in ["lecture", "speaker", "talk"]):
            ...
            elif any(w in title_lower for w in ["athletics", "game", "volleyball", "soccer", "tennis"]):
            ...
            event_record = {
                ...
                "tags": ["college", "agnes-scott", "decatur", "women"],
                "price_min": None,
                "price_max": None,
                "price_note": None,
                "is_free": True,
        ...
        logger.info(f"Agnes Scott College: Found {events_found} events, {events_new} new, {events_updated} existing")
