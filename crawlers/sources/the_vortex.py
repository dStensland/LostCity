...
Little Five Points legendary bar and restaurant.
...
WEEKLY_SCHEDULE = [
    {
        "day": 2,  # Wednesday
        "title": "Trivia at The Vortex",
        "description": (
            "Wednesday trivia night at The Vortex in Little Five Points. "
            "Pub trivia at one of Atlanta's most iconic bars, famous for burgers and the skull entrance."
        ),
        "start_time": "20:00",
        "category": "nightlife",
        "subcategory": "nightlife.trivia",
        "tags": ["trivia", "nightlife", "weekly", "iconic"],
    },
]
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Ensure The Vortex venue and generate recurring trivia events."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    for template in WEEKLY_SCHEDULE:
        ...
        for week in range(WEEKS_AHEAD):
            ...
            event_record = {
                ...
                "ticket_url": None,
                "image_url": None,
                "raw_text": f"{template['title']} at The Vortex - {start_date}",
    ...
    logger.info(
        f"The Vortex crawl complete: {events_found} found, {events_new} new, {events_updated} updated"
    )
