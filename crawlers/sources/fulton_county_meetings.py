"""
Crawler for Fulton County Government Meetings via Legistar.

Source: https://fulton.legistar.com/Calendar.aspx
Events: Board of Commissioners meetings, public hearings, committee meetings, zoning hearings
...
def determine_series_hint(meeting_name: str) -> Optional[dict]:
    ...
    if "board of commissioners" in meeting_name_lower and "regular" in meeting_name_lower:
        return {
            ...
            "series_title": "Fulton County Board of Commissioners Regular Meeting",
            "frequency": "monthly",
        }
    ...
    if "planning commission" in meeting_name_lower:
        return {
            "series_type": "recurring_show",
            "series_title": "Fulton County Planning Commission Meeting",
            "frequency": "monthly",
        }
...
def crawl(source: dict) -> tuple[int, int, int]:
    """
    Crawl Fulton County Legistar calendar for upcoming government meetings.
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            logger.info(f"Fetching Fulton County Legistar calendar: {CALENDAR_URL}")
        ...
        for row in meeting_rows:
            try:
                ...
                # Build description
                description_parts = [f"{meeting_name} of Fulton County Government."]
                if location:
                ...
                event_record = {
                    ...
                    "is_all_day": False,
                    "category": "community",
                    "tags": ["government", "public-meeting", "civic-engagement", "fulton-county"],
                    "price_min": None,
                    "price_max": None,
                    "price_note": None,
                    "is_free": True,
        ...
        logger.info(
            f"Fulton County crawl complete: {events_found} found, "
            f"{events_new} new, {events_updated} updated"
        )

    except Exception as e:
        logger.error(f"Failed to crawl Fulton County meetings: {e}")
        raise
