"""
Crawler for Vista Yoga (vistayogaatl.com).
...
BASE_URL = "https://www.vistayogaatl.com"
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Crawl Vista Yoga events using Playwright."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    try:
        with sync_playwright() as p:
            ...
            logger.info(f"Fetching Vista Yoga: {EVENTS_URL}")
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    content_hash = generate_content_hash(title, "Vista Yoga", start_date)
                    ...
                    description = "Event at Vista Yoga"
        ...
        logger.error(f"Failed to crawl Vista Yoga: {e}")
        raise
