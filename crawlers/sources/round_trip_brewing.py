...
BASE_URL = "https://www.roundtripbrewing.com"
...
def crawl(source: dict) -> tuple[int, int, int]:
    ...
    try:
        with sync_playwright() as p:
            ...
            logger.info(f"Fetching Round Trip Brewing: {EVENTS_URL}")
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    events_found += 1
                    content_hash = generate_content_hash(title, "Round Trip Brewing", start_date)
        ...
        logger.info(f"Round Trip Brewing crawl complete: {events_found} found, {events_new} new, {events_updated} updated")

    except Exception as e:
        logger.error(f"Failed to crawl Round Trip Brewing: {e}")
        raise
