...
def crawl(source: dict) -> tuple[int, int, int]:
    ...
    try:
        with sync_playwright() as p:
            ...
            logger.info(f"Fetching Cobb Energy Performing Arts Centre: {EVENTS_URL}")
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    event_record = {
                        ...
                        "venue_id": venue_id,
                        "title": title,
                        "description": "Event at Cobb Energy Performing Arts Centre",
        ...
        logger.info(
            f"Cobb Energy Performing Arts Centre crawl complete: {events_found} found, {events_new} new, {events_updated} updated"
        )
