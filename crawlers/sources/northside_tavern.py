...
BASE_URL = "https://www.northsidetavern.com"
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Crawl Northside Tavern events using Playwright."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    try:
        with sync_playwright() as p:
            ...
            logger.info(f"Fetching Northside Tavern: {EVENTS_URL}")
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    content_hash = generate_content_hash(title, "Northside Tavern", start_date)
                    ...
                    event_record = {
                        ...
                        "venue_id": venue_id,
                        "title": title,
                        "description": "Event at Northside Tavern",
                        ...
                        "category": "music",
                        "subcategory": "concert",
                        "tags": ["northside-tavern", "blues", "dive-bar", "west-midtown"],
                        "price_min": None,
                        "price_max": None,
                        "price_note": None,
                        "is_free": False,
        ...
        logger.error(f"Failed to crawl Northside Tavern: {e}")
        raise
