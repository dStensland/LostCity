    ...
    for ev in raw_events:
        try:
            ...
            event_record = {
                ...
                # Library programming is class-like (structured, scheduled
                # instruction or workshop session) — flag upstream so the feed
                # Lineup filter can exclude reliably regardless of category
