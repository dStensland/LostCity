...
def parse_session(session: dict, today: date) -> dict | None:
    ...
    description = (
        f"Public pickleball class at {venue_data['name']} through Gwinnett County Parks & Recreation. "
...
def crawl(source: dict) -> tuple[int, int, int]:
    ...
    if not target_group:
        logger.error("Gwinnett pickleball classes crawl aborted: Pickleball group missing")
        return 0, 0, 0
