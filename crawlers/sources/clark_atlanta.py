        ...
        if json_events:
            for event_data in json_events:
                ...
                event_record = {
                    ...
                    "venue_id": venue_id,
                    "title": title,
                    "description": event_data.get("description", f"Event at Clark Atlanta University")[:500],
            ...
            for event_data in text_events:
                ...
                event_record = {
                    ...
                    "venue_id": venue_id,
                    "title": title,
                    "description": f"Event at Clark Atlanta University, a historic HBCU in the Atlanta University Center.",
                    "start_date": start_date,
                    "start_time": None,
                    "end_date": None,
                    "end_time": None,
