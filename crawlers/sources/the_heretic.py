"""
Crawler for The Heretic (heretic.com).
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Crawl The Heretic events using Playwright."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    try:
        with sync_playwright() as p:
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    content_hash = generate_content_hash(title, "The Heretic", start_date)
                    ...
                    event_record = {
                        ...
                        "venue_id": venue_id,
                        "title": title,
                        "description": "Event at The Heretic",
        ...
        logger.info(
            f"The Heretic crawl complete: {events_found} found, {events_new} new, {events_updated} updated"
        )
