...
def crawl(source: dict) -> tuple[int, int, int]:
    """Crawl Atlanta Eagle events using Playwright."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    try:
            ...
            while i < len(lines):
                ...
                if date_match:
                    ...
                    event_record = {
                        ...
                        "venue_id": venue_id,
                        "title": title,
                        "description": "Event at Atlanta Eagle",
        ...
        logger.info(
            f"Atlanta Eagle crawl complete: {events_found} found, {events_new} new, {events_updated} updated"
        )
