...
Little Five Points craft beer bar with 125+ taps.
...
WEEKLY_SCHEDULE = [
    {
        "day": 2,  # Wednesday
        "title": "Trivia at The Porter",
        "description": (
            "Wednesday trivia night at The Porter Beer Bar in Little Five Points. "
            "Test your knowledge over craft beers from one of Atlanta's best beer lists."
        ),
        "start_time": "20:00",
        "category": "nightlife",
        "subcategory": "nightlife.trivia",
        "tags": ["trivia", "nightlife", "weekly", "craft-beer"],
    },
]
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Ensure The Porter Beer Bar venue and generate recurring trivia events."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    for template in WEEKLY_SCHEDULE:
        ...
        for week in range(WEEKS_AHEAD):
            ...
            event_record = {
                ...
                "ticket_url": None,
                "image_url": None,
                "raw_text": f"{template['title']} at The Porter Beer Bar - {start_date}",
