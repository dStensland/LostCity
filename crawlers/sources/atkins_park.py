"""
Crawler for Atkins Park Restaurant & Bar (atkinspark.com).
Virginia-Highland - Atlanta's oldest licensed bar (1922).
...
BASE_URL = "https://www.atkinspark.com"
WEEKS_AHEAD = 6

VENUE_DATA = {
    "name": "Atkins Park Restaurant & Bar",
    "slug": "atkins-park",
    ...
    "spot_type": "bar",
    "website": BASE_URL,
    "vibes": ["historic", "neighborhood-bar", "brunch", "patio", "craft-beer"],
}

WEEKLY_SCHEDULE = [
    {
        "day": 2,  # Wednesday
        "title": "Trivia at Atkins Park",
        "description": (
            "Wednesday trivia night at Atkins Park in Virginia-Highland. "
            "Pub trivia at Atlanta's oldest continuously licensed bar, open since 1922."
        ),
        "start_time": "20:00",
        "category": "nightlife",
...
def crawl(source: dict) -> tuple[int, int, int]:
    """Ensure Atkins Park venue and generate recurring trivia events."""
    source_id = source["id"]
    events_found = 0
    events_new = 0
    events_updated = 0
    ...
    for template in WEEKLY_SCHEDULE:
        ...
        for week in range(WEEKS_AHEAD):
            ...
            event_record = {
                ...
                "ticket_url": None,
                "image_url": None,
                "raw_text": f"{template['title']} at Atkins Park - {start_date}",
    ...
    logger.info(
        f"Atkins Park crawl complete: {events_found} found, {events_new} new, {events_updated} updated"
    )
