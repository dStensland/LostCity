#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's eighth private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave8_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave8_images_google.py
"""
...
TARGET_QUERIES = {
    "madison-rv-park": "Madison RV Park Georgia",
    "okefenokee-rv-park": "Okefenokee RV Park Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 8 Image Enrichment (Google Places)")
    print("=" * 72)
