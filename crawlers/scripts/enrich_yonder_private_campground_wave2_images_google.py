#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's second private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave2_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave2_images_google.py
"""
...
TARGET_QUERIES = {
    "georgia-veterans-state-park": "Georgia Veterans State Park Georgia",
    "georgia-veterans-state-park-campground": "Georgia Veterans State Park Campground Georgia",
    "blue-moon-campground": "Blue Moon Campground Georgia",
    "lake-harmony-rv-park": "Lake Harmony RV Park Georgia",
    "cecil-bay-rv-park": "Cecil Bay RV Park Georgia",
    "a-big-wheel-rv-park": "A Big Wheel RV Park Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 2 Image Enrichment (Google Places)")
    print("=" * 72)
