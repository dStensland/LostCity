#!/usr/bin/env python3
"""
Backfill short descriptions for non-Eventbrite events using real source-page
extraction.

This script is no longer part of the automated enrichment pipeline. It is a
manual recovery tool that fetches source URLs and extracts real content via
JSON-LD and Open Graph when available.
