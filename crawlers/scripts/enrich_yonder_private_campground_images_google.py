#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's private/operator campground wave via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_images_google.py
"""
...
PRIVATE_CAMPGROUND_QUERIES = {
    "stone-mountain-campground": "Stone Mountain Park Campground Georgia",
    "bainbridge-riverview-campground": "Bainbridge Riverview Campground Georgia",
    "beautiful-rock-campground": "Beautiful Rock Campground Georgia",
    "jennys-creek-campground": "Jenny's Creek Campground Georgia",
    "atlanta-south-rv-park": "Atlanta South RV Park Georgia",
}

PLACEHOLDER_PATTERNS = ("placeholder", "default")
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(PRIVATE_CAMPGROUND_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 72)
    print("Yonder Private Campground Image Enrichment (Google Places)")
    print("=" * 72)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in PRIVATE_CAMPGROUND_QUERIES.items():
