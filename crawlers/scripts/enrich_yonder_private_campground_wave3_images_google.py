#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's third private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave3_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave3_images_google.py
"""
...
TARGET_QUERIES = {
    "morganton-point-campground": "Morganton Point Campground Georgia",
    "albany-rv-resort": "Albany RV Resort Georgia",
    "talona-ridge-rv-resort": "Talona Ridge RV Resort Georgia",
    "lake-park-rv-campground": "Lake Park RV and Campground Georgia",
    "oz-campground": "Oz Campground Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 3 Image Enrichment (Google Places)")
    print("=" * 72)
