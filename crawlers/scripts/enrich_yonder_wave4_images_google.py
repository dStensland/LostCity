#!/usr/bin/env python3
"""
Backfill image coverage for Yonder Wave 4 support nodes via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_wave4_images_google.py --dry-run
    python3 scripts/enrich_yonder_wave4_images_google.py
"""
...
WAVE_4_QUERIES = {
    "chattahoochee-river-nra": "Chattahoochee River National Recreation Area Sandy Springs GA",
    "east-palisades-trail": "East Palisades Trail Atlanta GA",
    "indian-trail-entrance-east-palisades-unit-chattahoochee-nra": "Indian Trail East Palisades Atlanta GA",
    "whitewater-express-columbus": "Whitewater Express Columbus GA",
    "etowah-river-park": "Etowah River Park Canton GA",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(WAVE_4_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 68)
    print("Yonder Wave 4 Image Enrichment (Google Places)")
    print("=" * 68)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in WAVE_4_QUERIES.items():
