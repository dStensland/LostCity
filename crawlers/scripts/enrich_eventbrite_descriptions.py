#!/usr/bin/env python3
"""
Backfill short Eventbrite event descriptions using real detail-page enrichment.

This script is no longer part of the automated enrichment pipeline. It is a
manual recovery tool that expands thin Eventbrite API blurbs with FAQ/detail
content from the source page when available.
