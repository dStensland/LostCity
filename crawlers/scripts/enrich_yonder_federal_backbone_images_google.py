#!/usr/bin/env python3
"""
Backfill image coverage for Yonder federal backbone anchors via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_federal_backbone_images_google.py --dry-run
    python3 scripts/enrich_yonder_federal_backbone_images_google.py
"""
...
BACKBONE_QUERIES = {
    "cumberland-island-national-seashore": "Cumberland Island National Seashore Georgia",
    "chattahoochee-oconee-national-forest": "Chattahoochee-Oconee National Forest Georgia",
    "okefenokee-national-wildlife-refuge": "Okefenokee National Wildlife Refuge Georgia",
    "allatoona-lake": "Allatoona Lake Georgia",
    "lake-sidney-lanier": "Lake Sidney Lanier Georgia",
    "carters-lake": "Carters Lake Georgia",
    "hartwell-lake": "Hartwell Lake Georgia",
    "richard-b-russell-lake": "Richard B Russell Lake Georgia",
    "west-point-lake": "West Point Lake Georgia",
    "banks-lake-national-wildlife-refuge": "Banks Lake National Wildlife Refuge Georgia",
    "blackbeard-island-national-wildlife-refuge": "Blackbeard Island National Wildlife Refuge Georgia",
    "harris-neck-national-wildlife-refuge": "Harris Neck National Wildlife Refuge Georgia",
    "piedmont-national-wildlife-refuge": "Piedmont National Wildlife Refuge Georgia",
    "sapelo-island-national-estuarine-research-reserve": "Sapelo Island National Estuarine Research Reserve Georgia",
    "bond-swamp-national-wildlife-refuge": "Bond Swamp National Wildlife Refuge Georgia",
    "walter-f-george-lake": "Walter F George Lake Georgia",
    "george-w-andrews-lake": "George W Andrews Lake Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(BACKBONE_QUERIES.keys()))
        .execute()
    )
    ...
    skipped = 0
    print("=" * 72)
    print("Yonder Federal Backbone Image Enrichment (Google Places)")
    print("=" * 72)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")
    for slug, query in BACKBONE_QUERIES.items():
