#!/usr/bin/env python3
"""
Backfill image coverage for Yonder Wave 2 regional destinations via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_wave2_images_google.py --dry-run
    python3 scripts/enrich_yonder_wave2_images_google.py
"""
...
WAVE_2_QUERIES = {
    "desoto-falls": "Desoto Falls Recreation Area Suches GA",
    "helton-creek-falls": "Helton Creek Falls Blairsville GA",
    "rabun-bald": "Rabun Bald Trailhead GA",
    "black-rock-mountain": "Black Rock Mountain State Park Mountain City GA",
    "cohutta-overlook": "Cohutta Overlook Chatsworth GA",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(WAVE_2_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 68)
    print("Yonder Wave 2 Image Enrichment (Google Places)")
    print("=" * 68)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in WAVE_2_QUERIES.items():
