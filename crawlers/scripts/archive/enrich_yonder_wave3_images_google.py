#!/usr/bin/env python3
"""
Backfill image coverage for Yonder Wave 3 support nodes via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_wave3_images_google.py --dry-run
    python3 scripts/enrich_yonder_wave3_images_google.py
"""
...
WAVE_3_QUERIES = {
    "sweetwater-creek-state-park": "Sweetwater Creek State Park Lithia Springs GA",
    "panola-mountain": "Panola Mountain State Park Stonecrest GA",
    "cochran-shoals-trail": "Cochran Shoals Trail Marietta GA",
    "shoot-the-hooch-powers-island": "Powers Island Chattahoochee Sandy Springs GA",
    "island-ford-crnra-boat-ramp": "Island Ford Boat Ramp Sandy Springs GA",
    "chattahoochee-bend-state-park": "Chattahoochee Bend State Park Newnan GA",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 68)
    print("Yonder Wave 3 Image Enrichment (Google Places)")
    print("=" * 68)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in WAVE_3_QUERIES.items():
