#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's curated review-wave campgrounds.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_campgrounds_review_wave1_images_google.py --dry-run
    python3 scripts/enrich_yonder_campgrounds_review_wave1_images_google.py
"""
...
TARGET_QUERIES = {
    "tallulah-river-campground": "Tallulah River Campground Georgia",
    "mulberry-gap-adventure-basecamp": "Mulberry Gap Adventure Basecamp Georgia",
    "yonah-mountain-campground": "Yonah Mountain Campground Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Campgrounds Review Wave 1 Image Enrichment (Google Places)")
    print("=" * 72)
