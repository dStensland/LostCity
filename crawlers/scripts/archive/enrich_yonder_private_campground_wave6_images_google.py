#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's sixth private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave6_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave6_images_google.py
"""
...
TARGET_QUERIES = {
    "coastal-georgia-rv-resort": "Coastal Georgia RV Resort Georgia",
    "southern-retreat-rv-park": "Southern Retreat RV Park Georgia",
    "inland-harbor-rv-park": "Inland Harbor RV Park Georgia",
    "mcintosh-lake-rv-park": "McIntosh Lake RV Park Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 6 Image Enrichment (Google Places)")
    print("=" * 72)
