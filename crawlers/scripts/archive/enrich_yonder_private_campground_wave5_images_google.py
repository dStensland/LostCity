#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's fifth private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave5_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave5_images_google.py
"""
...
TARGET_QUERIES = {
    "country-oaks-campground-rv": "Country Oaks Campground and RV Georgia",
    "eagles-roost-rv-resort": "Eagle's Roost RV Resort Georgia",
    "georgia-peanut-rv-park": "Georgia Peanut RV Park Georgia",
    "pataula-creek-rv-campground": "Pataula Creek RV Campground Georgia",
    "battlefield-campground-rv-park": "Battlefield Campground and RV Park Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 5 Image Enrichment (Google Places)")
    print("=" * 72)
