#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's fourth private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave4_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave4_images_google.py
"""
...
TARGET_QUERIES = {
    "allatoona-landing-marine-resort-campground": "Allatoona Landing Marine Resort Campground Georgia",
    "camp-david-rv-resort": "Camp David RV Resort Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 4 Image Enrichment (Google Places)")
    print("=" * 72)
