#!/usr/bin/env python3
"""
Backfill image coverage for Yonder public-land trail rows via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_public_land_trail_images_google.py --dry-run
    python3 scripts/enrich_yonder_public_land_trail_images_google.py
"""
...
TRAIL_QUERIES = {
    "appalachian-trail": "Appalachian Trail Springer Mountain Georgia",
    "benton-mackaye-trail": "Benton MacKaye Trail Georgia",
    "bartram-trail": "Bartram Trail Rabun County Georgia",
    "arkaquah-trail": "Arkaquah Trail Hiawassee GA",
    "chattooga-river-trail": "Chattooga River Trail Clayton GA",
    "johns-mountain-trail": "Johns Mountain Trail Villanow GA",
    "keown-falls-trail": "Keown Falls Trail Villanow GA",
    "hitchiti-loop-trail": "Hitchiti Loop Trail Juliette GA",
    "hitchiti-trail": "Hitchiti Trail Juliette GA",
    "homestead-trail": "Homestead Trail Fort Mountain State Park GA",
    "big-rock-trail": "Big Rock Trail Fort Mountain State Park GA",
    "pinhoti-trail": "Pinhoti Trail Chatsworth GA",
    "gahuti-trail": "Gahuti Trail Fort Mountain State Park GA",
    "amadahy-trail": "Amadahy Trail Carters Lake GA",
    "moody-forest-tavias-trail": "Moody Forest Tavia's Trail Baxley GA",
    "pocket-trail": "Pocket Trail Pocket Recreation Area Georgia",
    "terrora-trail": "Terrora Trail Tallulah Gorge State Park Georgia",
    "upper-terrora-nature-trail": "Upper Terrora Nature Trail Tallulah Gorge State Park Georgia",
    "boarding-house-trail": "Boarding House Trail Scull Shoals Georgia",
    "chickamauga-creek-trail": "Chickamauga Creek Trail Chatsworth Georgia",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(TRAIL_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 72)
    print("Yonder Public-Land Trail Image Enrichment (Google Places)")
    print("=" * 72)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in TRAIL_QUERIES.items():
