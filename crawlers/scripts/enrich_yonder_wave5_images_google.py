#!/usr/bin/env python3
"""
Backfill image coverage for Yonder Wave 5 destinations via Google Places.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_wave5_images_google.py --dry-run
    python3 scripts/enrich_yonder_wave5_images_google.py
"""
...
WAVE_5_QUERIES = {
    "red-top-mountain-state-park": "Red Top Mountain State Park Cartersville GA",
    "hard-labor-creek-state-park": "Hard Labor Creek State Park Rutledge GA",
    "fort-yargo-state-park": "Fort Yargo State Park Winder GA",
    "don-carter-state-park": "Don Carter State Park Gainesville GA",
    "unicoi-state-park": "Unicoi State Park Lodge Helen GA",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(WAVE_5_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 68)
    print("Yonder Wave 5 Image Enrichment (Google Places)")
    print("=" * 68)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in WAVE_5_QUERIES.items():
