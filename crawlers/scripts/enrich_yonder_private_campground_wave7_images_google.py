#!/usr/bin/env python3
"""
Backfill image coverage for Yonder's seventh private/operator campground wave.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_private_campground_wave7_images_google.py --dry-run
    python3 scripts/enrich_yonder_private_campground_wave7_images_google.py
"""
...
TARGET_QUERIES = {
    "hucks-rv-park": "Huck's RV Park Georgia",
    "walkabout-camp-rv-park": "Walkabout Camp and RV Park Georgia",
    "cat-head-creek-rv-park": "Cat Head Creek RV Park Georgia",
    "rivers-end-campground-rv-park": "Rivers End Campground and RV Park Georgia",
    "341-rv-park": "341 RV Park Georgia",
}

FALLBACK_IMAGE_URLS = {
    "cat-head-creek-rv-park": "https://static.wixstatic.com/media/78b811_c9d9cf7850b44f1c9204dd49fa23928a~mv2_d_2463_1687_s_2.jpg",
}
...
def main(dry_run: bool = False) -> None:
    ...
    print("=" * 72)
    print("Yonder Private Campground Wave 7 Image Enrichment (Google Places)")
    print("=" * 72)
    ...
    for slug, query in TARGET_QUERIES.items():
        ...
        if not photo_url:
            photo_url = FALLBACK_IMAGE_URLS.get(slug)
            if not photo_url:
