"""Activate Atlanta major-event sources and grant Atlanta portal feed access."""
...
SOURCES = (
    {
        ...
        "url": "https://atlantablackpride.org/",
        "source_type": "scrape",
    ...
    },
    {
        ...
        "url": "https://www.atlantacarnival.org/",
        "source_type": "scrape",
...
def main() -> int:
    ...
    for spec in SOURCES:
        ...
        if existing_rows:
            ...
            health_tags = [
                tag for tag in (existing.get("health_tags") or []) if tag not in STALE_HEALTH_TAGS
            ]
            payload = {
                "name": spec["name"],
                "url": spec["url"],
