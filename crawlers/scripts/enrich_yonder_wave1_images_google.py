#!/usr/bin/env python3
"""
Backfill image coverage for Yonder Wave 1 regional destinations via Google Places.

This script is intentionally targeted. It only touches the canonical Wave 1
destination slugs and only updates image fields when missing or clearly
placeholder-grade.

Usage:
    cd /Users/coach/Projects/LostCity/crawlers
    python3 scripts/enrich_yonder_wave1_images_google.py --dry-run
    python3 scripts/enrich_yonder_wave1_images_google.py
"""
...
WAVE_1_QUERIES = {
    "amicalola-falls": "Amicalola Falls State Park Dawsonville GA",
    "blood-mountain": "Blood Mountain Blairsville GA",
    "boat-rock": "Boat Rock Bouldering Area Atlanta GA",
    "brasstown-bald": "Brasstown Bald Visitor Center Hiawassee GA",
    "cloudland-canyon": "Cloudland Canyon State Park Rising Fawn GA",
    "fort-mountain-state-park": "Fort Mountain State Park Chatsworth GA",
    "raven-cliff-falls": "Raven Cliff Falls Helen GA",
    "springer-mountain": "Springer Mountain Trailhead Blue Ridge GA",
    "tallulah-gorge": "Tallulah Gorge State Park Tallulah Falls GA",
    "vogel-state-park": "Vogel State Park Blairsville GA",
}
...
def main(dry_run: bool = False) -> None:
    ...
    result = (
        ...
        .in_("slug", list(WAVE_1_QUERIES.keys()))
        .execute()
    )
    ...
    print("=" * 68)
    print("Yonder Wave 1 Image Enrichment (Google Places)")
    print("=" * 68)
    print(f"Mode: {'dry-run' if dry_run else 'apply'}")
    print("")

    for slug, query in WAVE_1_QUERIES.items():
