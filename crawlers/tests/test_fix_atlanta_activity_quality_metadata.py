...
def test_fix_pack_covers_core_audit_findings() -> None:
    assert VENUE_METADATA_FIXES["main-event-atlanta"]["place_type"] == "entertainment"
    assert VENUE_METADATA_FIXES["metro-fun-center"]["website"] == "https://metrofuncenter.com/"
    assert VENUE_METADATA_FIXES["sparkles-family-fun-center-kennesaw"]["place_type"] == "games"
    assert VENUE_METADATA_FIXES["stars-and-strikes-dacula"]["place_type"] == "games"
