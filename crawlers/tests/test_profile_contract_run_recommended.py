...
from scripts.profile_contract_run_recommended import render_markdown, run_recommended


def test_run_recommended_delegates_to_executor(tmp_path: Path):
    calls = {}
...
def test_run_recommended_handles_done_state(tmp_path: Path):
    def fake_recommendation_fn(**kwargs):
        return {
            "status": "done",
