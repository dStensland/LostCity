...
#
# Compiled from historical synthetic builders in enrich_festival_descriptions.py,
# enrich_eventbrite_descriptions.py, enrich_non_eventbrite_descriptions.py
# (18 builders), and post_crawl_maintenance.py. The legacy enrichment scripts
# now use real extraction, but the patterns remain relevant for cleanup and
# guarding old synthetic rows already present in the database.
