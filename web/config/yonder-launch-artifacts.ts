export type YonderArtifactQuestId =
  | "waterfalls"
  | "summits"
  | "secret_atlanta"
  | "river_access"
...
export type YonderLaunchArtifactQuest = {
  id: YonderArtifactQuestId;
  title: string;
  subtitle: string;
};

export type YonderLaunchArtifact = {
  id: string;
  title: string;
  spotSlug: string;
  ...
  artifactType:
    ...
    | "starter";
  summary: string;
  questIds: YonderArtifactQuestId[];
  launchPriority: number;
};

export const YONDER_LAUNCH_ARTIFACT_QUESTS: YonderLaunchArtifactQuest[] = [
  {
    id: "waterfalls",
...
export const YONDER_LAUNCH_ARTIFACTS: YonderLaunchArtifact[] = [
  {
  ...
  },
  {
    ...
    artifactType: "hidden_green_space",
...
export function getYonderLaunchArtifactsForQuest(
  questId: YonderArtifactQuestId,
): YonderLaunchArtifact[] {
  return YONDER_LAUNCH_ARTIFACTS
    .filter((artifact) => artifact.questIds.includes(questId))
