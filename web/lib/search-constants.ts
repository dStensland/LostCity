...
export const SUBCATEGORIES: Record<string, { value: string; label: string }[]> = {
  ...
  museums: [
    { value: "museums.art", label: "Art Museum" },
    { value: "museums.history", label: "History" },
    { value: "museums.science", label: "Science" },
    { value: "museums.children", label: "Children's" },
    { value: "museums.cultural", label: "Cultural" },
    { value: "museums.exhibition", label: "Exhibition" },
  ],
  community: [
  ...
  nightlife: [
    ...
    { value: "nightlife.specials", label: "Specials" },
