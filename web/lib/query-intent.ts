...
const CATEGORY_KEYWORDS: { pattern: RegExp; category: string }[] = [
  ...
  { pattern: /\b(club|dj|party|going out)\b/i, category: "music" },
  { pattern: /\b(trivia|bingo|board game|poker|game night)\b/i, category: "games" },
  { pattern: /\b(dance|salsa|bachata|swing|latin night)\b/i, category: "dance" },
  { pattern: /\b(fitness|yoga|workout|run|crossfit|gym)\b/i, category: "fitness" },
  { pattern: /\b(workshop|pottery|painting|craft|cooking class)\b/i, category: "workshops" },
  { pattern: /\b(seminar|lecture|conference)\b/i, category: "education" },
  { pattern: /\b(book club|poetry|reading|author)\b/i, category: "words" },
  { pattern: /\b(volunteer|food bank|cleanup|tree planting)\b/i, category: "volunteer" },
  { pattern: /\b(civic|town hall|public meeting|government)\b/i, category: "civic" },
  { pattern: /\b(hike|hiking|nature walk|kayak|paddle)\b/i, category: "outdoors" },
