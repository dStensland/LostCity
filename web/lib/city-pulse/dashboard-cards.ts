...
const CARDS = {
  coffee: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "Coffee",
    href: `/${slug}?view=find&type=destinations&venue_type=restaurant&cuisine=coffee&open_now=true&tab=eat-drink&label=Coffee`,
  }),
  morning_walk: (slug: string): CardTemplate => ({
    ...
    href: `/${slug}?view=find&type=destinations&venue_type=park%2Ctrail%2Cgarden&tab=things-to-do&label=Parks+%26+Trails`,
  }),
  farmers_market: (slug: string): CardTemplate => ({
    ...
    value: "This weekend",
    icon: "Storefront",
    href: `/${slug}?view=find&type=events&categories=food_drink&genres=farmers-market&date=today`,
  }),
  parks: (slug: string): CardTemplate => ({
    ...
    value: "Near you",
    icon: "Tree",
    href: `/${slug}?view=find&type=destinations&venue_type=park%2Ctrail%2Cgarden&tab=things-to-do&label=Parks`,
  }),
  patio: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "SunHorizon",
    href: `/${slug}?view=find&type=destinations&vibes=outdoor-seating%2Crooftop%2Cpatio&open_now=true&tab=eat-drink&label=Patios`,
    accent: "var(--gold)",
  }),
  beltline: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "Path",
    href: `/${slug}?view=find&type=destinations&neighborhoods=Old+Fourth+Ward%2CInman+Park%2CReynoldstown%2CGrant+Park&open_now=true&tab=things-to-do&label=BeltLine`,
  }),
  live_music: (slug: string): CardTemplate => ({
    ...
    value: "Tonight",
    icon: "MusicNotes",
    href: `/${slug}?view=find&type=events&categories=music&date=today`,
    accent: "var(--coral)",
  }),
  nightlife: (slug: string): CardTemplate => ({
    ...
    value: "Trending",
    icon: "Martini",
    href: `/${slug}?view=find&type=events&categories=nightlife&date=today`,
  ...
  late_night: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "ForkKnife",
    href: `/${slug}?view=find&type=destinations&vibes=late-night&open_now=true&tab=eat-drink&label=Late+Night+Eats`,
  }),
  indoor: (slug: string): CardTemplate => ({
    ...
    value: "Stay dry",
    icon: "Umbrella",
    href: `/${slug}?view=find&type=destinations&venue_type=museum%2Cgallery%2Centertainment%2Carcade%2Cbowling%2Ccinema&tab=things-to-do&label=Indoor+Vibes`,
  }),
  happy_hour: (slug: string): CardTemplate => ({
    ...
    value: "Active now",
    icon: "BeerStein",
    href: `/${slug}?view=find&type=destinations&venue_type=bar%2Cbrewery%2Crestaurant&open_now=true&tab=eat-drink&label=Happy+Hour`,
    accent: "var(--gold)",
  }),
  museums: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "Bank",
    href: `/${slug}?view=find&type=destinations&venue_type=museum%2Cgallery&tab=things-to-do&label=Museums`,
  }),
  brunch: (slug: string): CardTemplate => ({
    ...
    value: "Open now",
    icon: "Egg",
    href: `/${slug}?view=find&type=destinations&venue_type=restaurant&cuisine=brunch_breakfast&open_now=true&tab=eat-drink&label=Brunch`,
    accent: "var(--gold)",
  }),
  food_events: (slug: string): CardTemplate => ({
    ...
    value: "Today",
    icon: "CookingPot",
    href: `/${slug}?view=find&type=events&categories=food_drink&date=today`,
  }),
  comedy: (slug: string): CardTemplate => ({
    ...
    value: "Tonight",
    icon: "SmileyWink",
    href: `/${slug}?view=find&type=events&categories=comedy&date=today`,
  }),
} as const;
