...
export default function BrandedHeader({
  ...
  // Logo size classes - branded uses larger logos
  const logoSizeClass = headerConfig.logo_size === "sm" ? "h-10" : headerConfig.logo_size === "md" ? "h-12" : "h-16";
        ...
        {branding?.logo_url ? (
          <div className="flex flex-col items-center gap-1">
            ...
            {!branding?.hide_attribution && (
              <div className="flex items-center gap-1 text-[0.6rem] text-[var(--muted)] font-mono">
