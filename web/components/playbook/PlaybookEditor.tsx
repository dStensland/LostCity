...
// Dynamically imported so that the 1.6MB mapbox-gl bundle is never included in
// the shared chunk.  All react-map-gl usage lives inside PlaybookMapInner.
const PlaybookMap = dynamic(() => import("@/components/playbook/PlaybookMapInner"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full relative overflow-hidden" style={{ background: "var(--void)" }}>
...
// PlaybookMap is the dynamically-imported PlaybookMapInner (defined at top of file)
