      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-[15%] z-[101] max-w-md mx-auto"
          >
            <div
            ...
            >
              ...
              <div className="p-4 border-b border-[var(--twilight)]">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button
                    onClick={onClose}
                    className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full hover:bg-[var(--twilight)] text-[var(--muted)] hover:text-[var(--cream)] transition-colors"
                    aria-label="Close"
                  >
                ...
                {reasons.length === 0 ? (
                  <div className="text-center py-6">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg bg-[var(--twilight)] text-[var(--cream)] font-mono text-sm hover:bg-[var(--coral)] hover:text-[var(--void)] transition-colors"
                    >
                      Set preferences
              ...
              <div className="p-4 border-t border-[var(--twilight)]">
                <div className="flex items-center justify-between gap-3">
                  <button
                    onClick={handleHide}
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-[var(--coral)] font-mono text-xs hover:bg-[var(--coral)]/10 transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-[var(--muted)] font-mono text-xs hover:text-[var(--cream)] hover:bg-[var(--twilight)] transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
