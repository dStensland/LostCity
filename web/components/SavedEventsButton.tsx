...
export default function SavedEventsButton() {
  ...
  return (
    ...
    >
      ...
      {/* Count badge */}
      {savedCount > 0 && (
        <span className="absolute top-0.5 right-0.5 min-w-[16px] h-4 px-1 bg-[var(--coral)] text-[var(--void)] text-xs font-bold rounded-full flex items-center justify-center">
