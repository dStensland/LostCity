...
const ORG_TYPES = [
  { id: "arts_collective", label: "Arts Collective" },
  { id: "community_group", label: "Community Group" },
  { id: "music_promoter", label: "Music Promoter" },
  { id: "dance_company", label: "Dance Company" },
  { id: "theater_company", label: "Theater Company" },
  { id: "nonprofit", label: "Nonprofit" },
  { id: "club_series", label: "Club / Event Series" },
  { id: "other", label: "Other" },
];

export default function SubmitOrgModal({ isOpen, onClose }: SubmitOrgModalProps) {
  ...
  const modalContent = (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="submit-org-title"
    >
          ...
          {modalState === "success" ? (
            <div className="text-center py-4">
              ...
              <p className="text-[var(--soft)] mb-6">
                We&apos;ll review your organization submission and reach out if we have questions.
              </p>
              <button
                onClick={onClose}
            ...
            <>
              <h2 id="submit-org-title" className="text-xl font-semibold text-[var(--cream)] mb-2">
                Submit an Organization
              </h2>
              <p className="text-sm text-[var(--soft)] mb-4">
                Know of a group, collective, or organization we should feature? Let us know.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Atlanta Arts Collective"
