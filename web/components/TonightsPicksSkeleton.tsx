    ...
    <section className="py-8 -mx-4 px-4 mb-6 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="flex gap-1 p-1 bg-[var(--night)] rounded-xl border border-[var(--twilight)]/30 mb-4">
          {[0, 1, 2].map((i) => (
            <div key={i} className="flex-1 h-9 skeleton-shimmer-enhanced rounded-lg" />
          ))}
        </div>

        {/* Section header skeleton */}
        <div className="flex items-center gap-3 mb-4 animate-reveal stagger-1">
          <div className="w-10 h-10 rounded-full skeleton-shimmer-enhanced" />
          <div>
            <div className="h-5 w-32 rounded skeleton-shimmer-enhanced mb-1" />
        ...
        {/* Hero card skeleton */}
        <div
          className="rounded-2xl overflow-hidden mb-4 relative bg-[var(--dusk)] animate-reveal stagger-2"
        >
          ...
          <div className="relative p-5 pt-32">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="h-5 w-16 rounded-full skeleton-shimmer-enhanced" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div
              key={i}
              className={`rounded-xl border border-[var(--twilight)] bg-[var(--dusk)] overflow-hidden animate-reveal stagger-${Math.min(i + 3, 10)}`}
            >
              <div className="h-24 skeleton-shimmer-enhanced" />
              <div className="p-3">
