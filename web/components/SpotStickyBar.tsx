...
export default function SpotStickyBar({ spotName, address, city, state, website, instagram }: Props) {
      ...
      <div className="bg-[var(--void)]/95 backdrop-blur-md border-t border-[var(--twilight)] px-4 py-3 safe-area-bottom">
        <div className="max-w-3xl mx-auto flex items-center gap-3">
          ...
          {directionsUrl ? (
            ...
            <div className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--twilight)] text-[var(--muted)] font-semibold rounded-lg cursor-default">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              </svg>
              {spotName}
