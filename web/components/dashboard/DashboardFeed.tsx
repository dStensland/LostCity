...
type RecommendationReason = {
  type: "followed_venue" | "followed_organization" | "neighborhood" | "vibes" | "price" | "friends_going" | "trending";
  label: string;
  detail?: string;
};
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="p-3 bg-[var(--dusk)] border border-[var(--twilight)] rounded-lg">
                <div className="w-full aspect-[4/3] skeleton-shimmer rounded-lg mb-2" />
                <div className="h-4 skeleton-shimmer rounded w-3/4 mb-1" />
      ...
      <section>
        ...
        {events.length === 0 ? (
          <div className="p-6 bg-[var(--dusk)] border border-[var(--twilight)] rounded-lg text-center">
            <p className="text-[var(--soft)] font-mono text-sm">No matches</p>
