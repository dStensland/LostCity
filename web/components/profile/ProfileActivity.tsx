...
function ActivityItem({ activity, portalSlug }: { activity: Activity; portalSlug: string }) {
  ...
  const getActivityIcon = () => {
    switch (activity.activity_type) {
      ...
      case "follow_venue":
        return (
          <div className="w-8 h-8 rounded-full bg-[var(--vibe)]/20 flex items-center justify-center flex-shrink-0">
            <svg className="w-4 h-4 text-[var(--vibe)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
