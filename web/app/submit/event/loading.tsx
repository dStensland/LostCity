  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        {/* Title */}
        <Skeleton className="h-8 w-48 rounded mb-2" delay="0.05s" />
        ...
        <div className="space-y-6">
          {/* Event title */}
          <div>
            <Skeleton className="h-3 w-20 rounded mb-2" delay="0.15s" />
            <Skeleton className="h-11 w-full rounded-lg" delay="0.2s" />
          </div>

          {/* Category */}
          <div>
            <Skeleton className="h-3 w-16 rounded mb-2" delay="0.25s" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Skeleton className="h-3 w-12 rounded mb-2" delay="0.35s" />
              <Skeleton className="h-11 w-full rounded-lg" delay="0.4s" />
            </div>
            <div>
              <Skeleton className="h-3 w-20 rounded mb-2" delay="0.35s" />
              <Skeleton className="h-11 w-full rounded-lg" delay="0.4s" />
            </div>
          </div>
