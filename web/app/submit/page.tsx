...
const submissionTypes = [
  {
    ...
    iconClass: "bg-[var(--coral)]/10 text-[var(--coral)] group-hover:bg-[var(--coral)]/20",
  },
  {
    type: "venue",
    href: "/submit/venue",
    ...
    iconClass: "bg-[var(--rose)]/10 text-[var(--rose)] group-hover:bg-[var(--rose)]/20",
  },
  {
    type: "org",
    href: "/submit/org",
    ...
    iconClass: "bg-[var(--gold)]/10 text-[var(--gold)] group-hover:bg-[var(--gold)]/20",
  },
];
        ...
        <div className="mb-8 p-6 rounded-xl bg-[var(--void)]/60 border border-[var(--twilight)]">
          ...
          <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
            ...
            <div className="p-3 rounded-lg bg-[var(--dusk)]/70 border border-[var(--twilight)]">
              ...
              <div className="text-[var(--cream)] text-sm mt-1">
                {loadingStats || trust?.score == null ? "—" : `${Math.round(trust.score * 100)}%`}
              </div>
            </div>
          </div>
          ...
          {submissionTypes.map((item) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 rounded-lg transition-colors ${item.iconClass}`}
                >
                  {item.icon}
                </div>
