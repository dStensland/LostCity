  ...
  return (
    <PortalProvider portal={request.portal}>
      ...
      <div
        ...
        >
          <NavigationProgress />
          {/* Search overlay moved to app/layout.tsx via RootSearchOverlay
              so non-portal pages (/community, /happening-now) also get
              an overlay when LaunchButton fires. Portal slug is derived
              from the URL pathname there, which matches this layout's
              route segment, so the overlay still scopes to this portal. */}
