...
export default function FilmShowtimeBoard({
  ...
  const visibleFilms = compact ? indieFilteredFilms.slice(0, 4) : indieFilteredFilms;
  const visibleTheaters = compact ? indieFilteredTheaters.slice(0, 6) : indieFilteredTheaters;
  ...
  return (
    <section className="rounded-3xl border border-[#27324a] bg-[#0b101d] p-4 sm:p-5">
      ...
      {mode === "by-film" && compact && indieFilteredFilms.length > visibleFilms.length && (
        <Link
      ...
      {mode === "by-theater" && compact && indieFilteredTheaters.length > visibleTheaters.length && (
        <Link
      ...
      {mode === "by-film" && indieFilteredFilms.length === 0 && (
