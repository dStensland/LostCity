          ...
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3">
                ...
                <FollowButton targetProducerId={producer.id} />
              </div>

              {/* Description */}
              {producer.description && (
                <p className="mt-4 text-[var(--soft)] text-sm leading-relaxed">
                  {producer.description}
                </p>
              )}
              ...
              <div className="flex flex-wrap items-center gap-3 mt-4">
                {producer.website && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--twilight)]/50 text-[var(--soft)] hover:text-[var(--cream)] text-sm transition-colors"
                  >
            ...
            <div className="flex flex-wrap gap-2">
              {producer.categories.map((cat) => {
                ...
                return (
                  ...
                  >
                    <CategoryIcon type={cat} size={14} glow="subtle" />
                    {cat.replace(/_/g, " ")}
                  </span>
                );
              })}
