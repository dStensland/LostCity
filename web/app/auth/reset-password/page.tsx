...
export default function ResetPasswordPage() {
  ...
  return (
    <AuthLayout>
      ...
      {success ? (
        <div className="text-center">
          <div className="mb-6 p-4 rounded-lg bg-[var(--neon-green)]/10 border border-[var(--neon-green)]">
            <svg
              className="w-12 h-12 text-[var(--neon-green)] mx-auto mb-3"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <h2 className="font-mono text-sm font-medium text-[var(--neon-green)] mb-2">
              Password updated!
            </h2>
            <p className="font-mono text-xs text-[var(--muted)]">
