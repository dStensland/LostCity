-- Sync search_events_ranked to use unified data_quality column
-- instead of manual 3-field check. Matches updated 20260305200000.
...
IS 'Full-text search for events with time-decay, unified data_quality ranking, and feed quality gate. v4 2026-03-05.';
