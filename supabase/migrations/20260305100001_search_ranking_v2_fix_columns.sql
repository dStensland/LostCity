-- Hotfix: search_ranking_v2 used e.category instead of e.category_id
-- and e.subcategory which doesn't exist. This corrects the column references.
...
IS 'Full-text search for events with time-decay and data-quality ranking multipliers. v2.1 2026-03-05 — fixed column names.';
