-- ============================================
-- MIGRATION 363: Cobb Beginner Swimming Lessons Source
-- ============================================
-- Public beginner swim lessons from Cobb County Parks.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping Cobb beginner swimming lessons source registration.';
    RETURN;
  END IF;
  ...
  VALUES (
    'cobb-beginner-swimming-lessons',
    'Cobb Beginner Swimming Lessons',
  ...
  VALUES
    (
      ...
      'community_center',
      'https://secure.rec1.com/GA/cobb-county-ga/catalog',
      'Cobb County aquatic center hosting beginner swim lessons.'
    )
  ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
