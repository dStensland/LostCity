-- ============================================
-- MIGRATION 371: Spruill Summer Camps Source
-- ============================================
-- Official Spruill summer camps landing page and course-detail pages.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Official camp landing page with public registration detail pages exposing
--   exact dates, times, and pricing for summer camp sessions.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Spruill Summer Camps source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'spruill-summer-camps';
