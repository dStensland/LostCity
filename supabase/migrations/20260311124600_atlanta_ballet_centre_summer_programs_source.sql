-- ============================================
-- MIGRATION 367: Atlanta Ballet Centre Summer Programs Source
-- ============================================
-- Official Atlanta Ballet Centre for Dance Education summer programs.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Brand-owned summer-program hub with public age bands, dated sessions,
--   and a first-party registration-request flow.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Atlanta Ballet Centre summer programs source.';
  END IF;
  ...
  VALUES (
    'atlanta-ballet-centre-summer-programs',
    'Atlanta Ballet Centre Summer Programs',
    'https://centre.atlantaballet.com/summer-programs',
    'venue',
    'weekly',
    true,
    'requests',
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'atlanta-ballet-centre-summer-programs';
