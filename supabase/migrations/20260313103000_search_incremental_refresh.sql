-- Incremental search corpus refresh + broader generated aliases.
-- Keeps autocomplete fresh after crawl runs without requiring a full rebuild
-- every time, while also expanding alias coverage from slugs and stripped names.
...
BEGIN
  ...
  SELECT
    ...
    o.city,
    GREATEST(COALESCE(o.total_events_tracked, 1), 1),
    'organizations.generated_aliases'
  FROM organizations o
