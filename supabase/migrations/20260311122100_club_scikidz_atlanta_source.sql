-- ============================================
-- MIGRATION 353: Club SciKidz Atlanta Source
-- ============================================
-- STEM summer camp provider with public concept pages plus session-level ACTIVE
-- registration links across metro Atlanta host sites.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Club SciKidz source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'club-scikidz-atlanta';
