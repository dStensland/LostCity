-- ============================================
-- MIGRATION 484: City Moments RPC update
-- ============================================
-- Updates get_public_profile to include city_moment_url and
-- city_moment_thumbnail_url in the always-visible base fields.
--
...
BEGIN
  ...
  -- Always-visible base fields (city moment is public like avatar_url)
  v_result := jsonb_build_object(
    'id',                       v_profile.id,
    'username',                 v_profile.username,
    'display_name',             v_profile.display_name,
    'avatar_url',               v_profile.avatar_url,
    'city_moment_url',          v_profile.city_moment_url,
    'city_moment_thumbnail_url', v_profile.city_moment_thumbnail_url,
...
COMMENT ON FUNCTION get_public_profile(TEXT, UUID) IS
  ...
  'city_moment_url, city_moment_thumbnail_url, and optional current_hang. '
