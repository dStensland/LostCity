-- ============================================
-- MIGRATION 370: High Museum Summer Art Camp Source
-- ============================================
-- Official High Museum summer art camp pages.
--
-- Portal strategy:
--   Owner:       hooky
--   Subscribers: atlanta
--
-- Pattern role:
--   Institution-led camp pages with grade-band tabs, rising-kindergarten
--   weekly sessions, and direct buy/waitlist links.
-- ============================================
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register High Museum Summer Art Camp source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'high-museum-summer-art-camp';
