-- Remove the generic "opportunities" family from federation.
--
-- Runtime taxonomy now uses concrete families like `open_calls` and
-- `volunteer_opportunities`, so the federation storage layer should not
-- materialize a phantom umbrella family.
