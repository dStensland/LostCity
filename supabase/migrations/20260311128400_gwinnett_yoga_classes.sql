-- ===============================================
-- MIGRATION 378: Gwinnett Yoga Classes Source
-- ===============================================
-- Public yoga classes from Gwinnett County Parks & Recreation.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping Gwinnett yoga source registration.';
    RETURN;
  END IF;
