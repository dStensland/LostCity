...
INSERT INTO venues (name, slug, address, neighborhood, city, state, zip, lat, lng, venue_type, spot_type, website, description, vibes, studio_type, availability_status, monthly_rate_range, is_active)
SELECT 'TILA Studios', 'tila-studios', '1021 Howell Mill Rd NW', 'West Midtown', 'Atlanta', 'GA', '30318',
  ...
  'private', 'waitlist', '$400-$700', true
WHERE NOT EXISTS (SELECT 1 FROM venues WHERE slug = 'tila-studios');

-- Dashboard Co-op — artist-run cooperative
INSERT INTO venues (name, slug, address, neighborhood, city, state, zip, lat, lng, venue_type, spot_type, website, description, vibes, studio_type, availability_status, is_active)
...
SELECT 'Wonderroot', 'wonderroot', '982 Memorial Dr SE', 'Grant Park', 'Atlanta', 'GA', '30316',
  ...
  'shared', 'application_only', '$100-$300', true
