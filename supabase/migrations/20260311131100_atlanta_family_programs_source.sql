-- Mirror of database/migrations/417_atlanta_family_programs_source.sql
...
BEGIN
  ...
  IF atlanta_id IS NULL THEN
    RAISE EXCEPTION 'Atlanta portal not found. Cannot register Atlanta Family Programs source.';
  END IF;
  ...
  SELECT id INTO src_id FROM sources WHERE slug = 'atlanta-family-programs';
