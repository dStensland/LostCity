-- ============================================
-- MIGRATION 361: Cobb Basketball Training RARC Source
-- ============================================
-- Public youth basketball training at Ron Anderson Recreation Center.
...
BEGIN
  ...
  IF atlanta_portal_id IS NULL THEN
    RAISE NOTICE 'Atlanta portal not found. Skipping Cobb basketball training RARC source registration.';
    RETURN;
  END IF;
  ...
  VALUES
    (
      ...
      'community_center',
      'https://secure.rec1.com/GA/cobb-county-ga/catalog',
      'Cobb County recreation center hosting public youth basketball training.'
    )
  ON CONFLICT (slug) DO UPDATE SET
    name = EXCLUDED.name,
